...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Passaporte para o Caos | Em breve",
      },
      {
...
const instagramUrl =
  "https://www.instagram.com/passaporteparaocaos/";

const facebookUrl =
  "https://www.facebook.com/profile.php?id=61594587063784";

const youtubeUrl =
  "https://www.youtube.com/@PassaporteParaOCaos";
    ...
    >
        ...
        <div className="relative z-10 grid flex-1 items-center gap-10 py-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-6 lg:py-8">
          <div className="relative z-10 max-w-3xl lg:py-12">
            ...
            <h1 className="font-display text-[clamp(3.6rem,8vw,7.8rem)] leading-[0.86] font-semibold text-balance">
              Viajar também é{" "}
              <span className="text-accent">se perder.</span>
            </h1>

            <p className="mt-8 max-w-xl font-sans text-base leading-7 text-muted-foreground sm:text-lg">
              Histórias reais de viagens, perrengues, encontros inesperados e
              tudo o que não estava no roteiro.
            </p>
      ...
      <section className="border-y border-border bg-secondary px-6 py-16 sm:px-10 lg:py-20">
        <p className="mx-auto max-w-4xl text-center font-display text-2xl leading-relaxed text-foreground sm:text-4xl sm:leading-snug">
          Algumas viagens viram lembranças. Outras viram histórias. As melhores
          talvez sejam justamente aquelas que não saíram como planejado.
        </p>
      </section>
      ...
      <section
        id="sobre"
        className="bg-background px-6 py-16 sm:px-10 lg:py-24"
      >
        <div className="mx-auto grid max-w-[1312px] gap-12 lg:grid-cols-[0.82fr_1.15fr_0.68fr] lg:gap-10 lg:items-start">
          ...
          <div className="lg:pt-4">
            ...
            <div className="mt-6 max-w-xl space-y-4 font-sans text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">
              ...
              <p>
                No Passaporte para o Caos, compartilho relatos reais — meus, de
                convidados e da comunidade — mostrando que viajar é muito mais
                do que fotos bonitas. É se permitir viver o inesperado,
                aprender com o caos e colecionar experiências que se
                transformam em histórias.
              </p>
            </div>
      ...
      {/* ENVIE SUA HISTÓRIA */}
      <section
        id="envie-sua-historia"
        className="relative w-full overflow-hidden"
      >
        {/* Fotografia */}
        <div className="absolute inset-0" aria-hidden="true">
          <img
            src="/historia-paisagem.png"
            alt=""
          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-16">
            ...
            <div className="max-w-2xl text-primary-foreground">
              ...
              <div className="mt-6 space-y-4 font-sans text-base leading-7 text-primary-foreground/90 sm:text-lg sm:leading-8 [text-shadow:0_1px_10px_color-mix(in_oklab,black_55%,transparent)]">
                <p>
                  Você viveu uma história que parece mentira? Um perrengue
                  inesquecível? Uma situação absurda a bordo? Um encontro que
                  saiu completamente do roteiro? Então talvez essa história
                  pertença ao Passaporte para o Caos.
                </p>

                <p>
                  Enquanto nosso espaço para envio de histórias não fica
                  pronto, você já pode mandar a sua diretamente para a gente.
                </p>
              </div>
      ...
      <section className="border-b border-border bg-secondary px-6 py-12 sm:px-10">
        <div className="mx-auto max-w-3xl space-y-3 font-sans text-[0.82rem] leading-relaxed text-muted-foreground sm:text-sm sm:leading-relaxed">
          <p>
            Importante: o envio da história não significa publicação
            automática. A equipe do Passaporte para o Caos analisará o
            material antes de utilizá-lo.
          </p>

          <p>
            Para preservar a identidade do autor ou de outras pessoas
            mencionadas, informações identificáveis poderão ser alteradas,
            omitidas ou substituídas durante a edição, incluindo nomes,
            apelidos, cargos, empresas, navios, cidades, locais, datas, rotas
            ou outros detalhes que possam permitir a identificação de uma
            pessoa.
          </p>

          <p>
            Quando necessário, a história também poderá ser adaptada
            editorialmente para preservar o anonimato, sem alterar o sentido
            essencial do relato.
          </p>
        </div>
      </section>
